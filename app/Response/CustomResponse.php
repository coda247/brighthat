...
class CustomResponse
{
    ...
    public function is400Response($response,$responseMessage, $notValidator = false)
    {
        $responseMessage = json_encode(["notValidator"=> $notValidator, "success"=>false,"response"=>$responseMessage]);
        $response->getBody()->write($responseMessage);
        return $response->withHeader("Content-Type","application/json")
            ->withStatus(400);
    }
